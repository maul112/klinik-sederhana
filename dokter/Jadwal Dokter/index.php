...
<body>
    <div id="sidebar" class="sidebar">
        ...
        <a href="../index.php"><button class="sidebar-btn">Dashboard</button></a>
        <a href="#"><button class="sidebar-btn active">Jadwal Dokter</button></a>
        <a href="../Visit Report"><button class="sidebar-btn">Visit Report</button></a>
    </div>
            ...
            <table>
                ...
                <tbody>
                    <?php if ($result && $result->num_rows > 0): ?>
                        <?php while ($jadwal = $result->fetch_assoc()): ?>
                            <tr>
                                <td><?= htmlspecialchars($jadwal['hari_praktik']) ?></td>
                                <td><?= htmlspecialchars($jadwal['jam_praktik']) ?></td>
                                <td><?= htmlspecialchars($jadwal['status']) ?></td>
                                <td>
                                    <a href="detail.php?id=<?= urlencode($jadwal['id_jadwal']) ?>" class="action-btn">Ubah</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="4">Tidak ada jadwal yang tersedia.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
