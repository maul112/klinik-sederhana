...
$temp = mysqli_query($conn, "SELECT * FROM lab_data WHERE kategori = 'Biomolekuler'");
...
<body>
    <div class="container">
        ...
        <div class="filters">
            ...
            <a href="../biomolekuler/indeks.php"><button class="filter-button active">Biomolekuler</button></a>
            <a href="../patology/indeks.php"><button class="filter-button">Patology</button></a>
            <a href="../parasitologi/index.php"><button class="filter-button">Parasitology</button></a>
        </div>
        <div class="cards">
