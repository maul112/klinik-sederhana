...
$temp = mysqli_query($conn, "SELECT * FROM lab_data WHERE kategori = 'Mikrobiologi'");
...
<body>
    <div class="container">
        ...
        <div class="filters">
            <a href="../mikrobiologi/indeks.php"><button class="filter-button active">Mikrobiology</button></a>
