...
<html lang="en">
    ...
    <main>
        <header>
            <section class="py-2 text-center container">
                <div class="row py-lg-2">
                    <div class="col-1">
                        <a href="apotek1.php" class="text-decoration-none px-3 py-2 mt-4 d-block">Back</a>
                    </div>
                    <div class="col-10">
        ...
        <form action="../pembayaran/PAYMENT.php" method="post">
            <h2>Cart</h2>
            <div id="cart"></div>
            <div class="cart-total">
                <span>Total:</span>
                <!-- <span id="totalPrice" class="cart-total-price">Rp.0</span> -->
                <!-- <input type="text" id="totalPrice" class="border-0" readonly name="medicinePrice" value="Rp.0">
            </div>
            <div class="cart-checkout">
                <button type="submit" name="buymedicine">Continue To Pay</button>
            </div>
        </form>
        </div> --> -->
