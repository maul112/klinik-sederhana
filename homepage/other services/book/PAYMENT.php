...
if(isset($_POST["next"])) {
    ...
    // ambil harga poli
    $getHarga = mysqli_query($conn, "SELECT * FROM poli WHERE poli_name = '$poli'");
    $amountMed = mysqli_fetch_assoc($getHarga)['harga'];
}
...
if(isset($_POST['konfirmasi'])) {
    ...
    $getAntrian = mysqli_query($conn, "SELECT no_antrian FROM antrian WHERE poly = '$poli' AND date = '$date' ORDER BY date DESC LIMIT 1");
    if(mysqli_num_rows($getAntrian) == 0) {
        $no_antrian = 1;
    } else {
...
<body>
    <div class="container">
        ...
        <div class="payment-options">
            ...
            <div class="options">
                ...
                <button class="option" id="apple-pay-option"><img src="../pembayaran/applepay.png" alt="Apple Pay"></button></a>
                <a href="https://www.paypal.com/id/home">
                <button class="option" id="paypal-option"><img src="../pembayaran/paypal.png" alt="PayPal"></button></a>
            </div>
        </div>
        ...
        <div class="continue-button-container">
            <form method="post">
                ...
                <input type="hidden" name="dokter" value="<?= $dokter ?>">
    ...
    createQrisCharge().then(qrCodeUrl => {
        document.getElementById('qris-code-container').innerHTML = `<img src="../pembayaran/qr.png" alt="QRIS Code">`;
    });
