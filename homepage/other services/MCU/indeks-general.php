...
// Ambil data kategori General MCU
$temp = mysqli_query($conn, "SELECT * FROM mcu_data WHERE kategori = 'General MCU'");
...
<body>
    <div class="container">
        ...
        <div class="filters">
            ...
            <a href="indeks-general.php"><button class="filter-button active">General MCU</button></a>
        </div>
        <div class="cards">
