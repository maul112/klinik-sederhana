...
<body>
    <div class="container">
        ...
        <div class="filters">
            ...
            <a href="indeks-children.php"><button class="filter-button active">Children</button></a>
        ...
        <div class="cards">
        <?php
        // Query untuk mendapatkan data paket MCU kategori "Children"
        $temp = mysqli_query($conn, "SELECT * FROM mcu_data WHERE kategori = 'Children'");
